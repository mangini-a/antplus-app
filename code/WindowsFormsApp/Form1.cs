...
namespace WindowsFormsApp
{
    public partial class Form1 : Form
    {
        ...
        private void ConfigureANT()
        {
            ...
            // Handle events generated by the heart rate monitor (a receive rate of 1.02 Hz is enough)
        ...
        private void StartButton_Click(object sender, EventArgs e)
        {
            ...
            controller = new Controller(setpoint, kp: 0.5, ki: 0.025);
        ...
        private void ControlTimer_Tick(object sender, EventArgs e)
        {
            ...
            Console.WriteLine($"Computed resistance: {newResistance}%");
